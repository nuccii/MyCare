...
public class MedicinesController {
    ...
    static int[][] websites  = {
            ...
            {R.string.headacheProthiadenWebsite, R.string.headacheAsprinWebsite, R.string.headacheParacetamolWebsite, R.string.headacheZolmitriptanWebsite, R.string.headacheNaproxenWebsite},
